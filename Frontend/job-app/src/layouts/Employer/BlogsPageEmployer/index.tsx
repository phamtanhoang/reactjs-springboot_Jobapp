...
import { AddPage, TablePage } from "./components";

const BlogsPageEmployer = () => {
  ...
  return (
    <section className="flex-grow">
      ...
      {showBoxAdd && localStorage.getItem("employerToken") && (
        <AddPage setShowBoxAdd={setShowBoxAdd} />
      )}
    </section>
  );
};
export default BlogsPageEmployer;
