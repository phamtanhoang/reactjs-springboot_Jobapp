...
export const ChangePasswordPageEmployer: React.FC<{ setShowBox?: any }> = (
  props
) => {
    ...
    if (currentPassword && newPassword && comfirmNewPassword) {
      authsAPI
        .changePassword(
          ...
          newPassword,
          comfirmNewPassword,
          localStorage.getItem("emloyerToken") || ""
        )
        .then((res) => {
          props.setShowBox(false);
          localStorage.removeItem("emloyerToken");
          navigate("/employer/login");
          Swal.fire("Success", `${res.data}!!! Please login again`, "success");
        })
        .catch((error: any) => {
