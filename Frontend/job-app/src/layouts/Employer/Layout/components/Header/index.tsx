...
const Header:React.FC<{isNavBarVisible: any, setIsNavBarVisible: any}> = (props) => {
      ...
      <div className="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
        <div className="flex">
          <div className="lg:hidden flex items-center mr-4">
            <button className="hover:text-blue-500 hover:border-white focus:outline-none navbar-burger" onClick={() => props.setIsNavBarVisible(!props.isNavBarVisible)}>
