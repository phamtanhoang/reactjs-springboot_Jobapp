      ...
      <div className="w-4/5 mx-auto mt-10 flex items-center lg:mt-0 lg:mb-5 lg:flex-row flex-col">
        ...
        {/* <div className="lg:w-[45%] w-full">
          ...
          <p className="font-normal text-neutral-500 mb-8">
            ...
            thông báo và bạn có thể dễ dàng nộp đơn trực tiếp cho công ty bạn
            muốn và tạo một tài khoản miễn phí ngay bây giờ
          </p>
        ...
        <div className="lg:w-[45%] w-full">
          ...
          <p className="font-normal text-neutral-500 mb-8">
            Chỉnh sửa hồ sơ để nhận thông tin công việc bạn muốn, nhận hàng ngày
            thông báo và bạn có thể dễ dàng nộp đơn trực tiếp cho công ty bạn
            muốn và tạo một tài khoản miễn phí ngay bây giờ
          </p>
          <button className="text-white px-8 py-2 rounded-full font-semibold bg-orangetext">
