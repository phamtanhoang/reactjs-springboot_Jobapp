const BlogDetailPage = () => {
  return (
    <>
      <main className="py-8  md:py-16  antialiased">
                ...
                <div className="inline-flex items-center mr-3 text-sm text-gray-800 ">
                  ...
                  <div>
                    <a
                      href="#"
                      rel="author"
                      className="text-xl font-bold text-gray-800 hover:text-orangetext"
                    >
                      Jese Leos
                    </a>
                    ...
                    <p className="text-base text-gray-500 ">Feb. 8, 2022</p>
                  </div>
                </div>
              </address>
            ...
            <section className="mt-6">
              ...
              <form className="mb-6">
                <div className="mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 ">
                  <label className="sr-only">Bình luận của bạn</label>
                  <textarea
                    className="block px-4 py-3  w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-orangetext focus:border-orangetext h-24"
                ...
                <button
                  type="submit"
                  className="inline-flex items-center py-2.5 px-4 text-base font-medium text-center text-white bg-orangetext rounded-lg focus:ring-4 focus:ring-orangebackground hover:bg-primary-800"
                >
                  Gửi bình luận
                </button>
              </form>
